...
HDF5 1.15 that was compiled on;
    Linux 6.5.0-17-generic x86_64, using GNU C 11.4.0.
...
The contents of this directory are:
    ...
    README.md               - This file
    HDF5-1.15.0-Linux.sh    - HDF5 Install Package
...
Installation
===========================================================================
1. Execute HDF5-1.15.0-Linux.sh
2. Follow prompts
===========================================================================
...
To test the installation with the examples;
    ...
    The default installation folder is defined as "/usr/local/HDF_Group/HDF5/1.15.0".
